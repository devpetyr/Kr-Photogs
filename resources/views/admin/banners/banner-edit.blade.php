                            ...
                            <form action="{{route('admin_banners_add_edit',[$banner->id])}}" method="POST" enctype="multipart/form-data">@csrf
                                <div>
                                    ...
                                    <div class="form-file mb-3">
                                        <input type="file" class="form-file-input" id="customFile"  name="title" onchange="loadFile($(this))">
                                        <label class="form-file-label" for="customFile">
                                            <span class="form-file-text">Choose file...</span>
                                            <span class="form-file-button">Browse</span>
                                        </label>
                                        <img class="img-fluid image-preview" alt="" id="" src="{{url('uploads/banners/').'/'.$banner->title}}">
                                    </div>
